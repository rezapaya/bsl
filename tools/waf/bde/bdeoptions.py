                ...
                for line in opts_strm:
                    ...
                    if not continuation:
                        ...
                        if m:
                            ...
                            mc = RawOptions.OPT_INLINE_COMMAND_RE.search(option.value)
                            if mc:
                                v = option.value
                                cmd_out = self.ctx.cmd_and_log(mc.group(1)).rstrip()
...
class Options(object):
    ...
    def _store_raw_option(self, option, debug_opt_keys=None):
    ...
    def read(self, raw_options, debug_opt_keys=None):
        for raw_option in raw_options:
            self._store_raw_option(raw_option, debug_opt_keys)
